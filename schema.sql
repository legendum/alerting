...
-- quota_basic: decremented by 1 when a webhook with basic default policy fires; reset to 100 at midnight in the token's timezone (tokens.timezone) every day.
